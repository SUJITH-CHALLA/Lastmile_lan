...
import { MapPin, DollarSign, Building, Sparkles, Bookmark, Clock, Zap } from "lucide-react"
        ...
        <Card className="flex flex-col md:flex-row gap-4 md:gap-6 p-6 border-2 border-black shadow-neo hover:shadow-neo-lg transition-all hover:translate-x-[-2px] hover:translate-y-[-2px] bg-white group">
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-col sm:flex-row gap-4 mt-auto">
                    <Button className="flex-1 border-2 border-black shadow-neo active:shadow-none font-black uppercase text-black bg-green-400 hover:bg-green-500 gap-2">
                        <Zap size={18} className="fill-black" /> One-Click Apply
                    </Button>
                    <Button variant="outline" className="flex-1 border-2 border-black shadow-neo active:shadow-none font-bold flex items-center justify-center gap-2 hover:bg-gray-100">
                        Ask AI-E
